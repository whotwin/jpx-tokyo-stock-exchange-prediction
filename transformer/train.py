...
from .config import device, TRANSFORMER_BATCH_SIZE, TRANSFORMER_EPOCHS, TRANSFORMER_LEARNING_RATE


def train_transformer_model(model, train_loader, epochs=None, lr=None):
